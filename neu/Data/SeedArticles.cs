                ...
                serviceProvider.GetRequiredService<DbContextOptions<ApplicationDbContext>>()))
            {
                ...
                context.Articles.AddRange(
                    new Article
                    {
                        Title = "ヒナまつり",
                        Subtitle = "黑社会的超能力女儿",
                        Content = "支持着芦川组的年轻智力型黑道新田义史，过着被喜欢的壶所包围的悠然自得单身生活。但某一天，随着装在神秘物体里的少女雏来到他家，他的生活为之一变。他被能使用念动力的雏所胁迫，迫不得已开始和她同居！\n" +
                    ...
                    new Article
                    {
                        Title = "メガロボクス",
                        Subtitle = "Megalo Box",
                        Content = "将肉体与“齿轮技术”融合的究极格斗技——“MEGALO BOX”，将自己的全部赌在上面的男人们的热血战斗开始！\n" +
